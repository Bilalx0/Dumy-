            ...
            <div className="flex items-center space-x-4">
              <div className="flex items-center space-x-2 md:space-x-4">
                    ...
                    <div className="absolute left-0 mt-2 w-64 bg-white shadow-lg border border-gray-300 p-4  z-10">
                      <div className="flex flex-wrap gap-2">
                        {[..."123456"].map((num) => (
                          <button
                            key={num}
                            className="px-2 py-2 font-inter text-black border border-[#00603A] hover:bg-[#00603A] hover:text-white transition-all duration-300"
                          >
                            {num}
                          </button>
                        ))}
                        <button className="px-2 py-2 font-inter text-black border border-[#00603A] hover:bg-[#00603A] hover:text-white transition-all duration-300">
                          7+
                        </button>
                      </div>
                      <div className="flex justify-between">
                ...
                <div className="relative inline-block">
                  ...
                  {activePopup === "more" && (
                    <div className="absolute left-0 mt-2 w-80 bg-white shadow-lg border border-gray-300 p-4  z-10">
                      <h2 className="mb-4">Completion</h2>
                      <div className="flex justify-between">
                        {["Any", "Ready", "Under Construction"].map(
                          (option) => (
                            <button
                              key={option}
                              className="px-2 py-2 font-inter text-black border border-[#00603A] hover:bg-[#00603A] hover:text-white transition-all duration-300"
